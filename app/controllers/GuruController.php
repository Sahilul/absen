    ...
    private function sendAbsensiNotifications($postData)
    {
        try {
            ...
            foreach ($siswaNotHadir as $id_siswa => $status) {
                ...
                // Kirim ke Ayah jika ada nomor HP
                if (!empty($siswa['ayah_no_hp'])) {
                ...
                // Kirim ke Ibu jika ada nomor HP
                if (!empty($siswa['ibu_no_hp'])) {
                ...
                // Kirim ke Wali jika ada nomor HP dan ortu tidak ada
                if (!empty($siswa['wali_no_hp']) && empty($siswa['ayah_no_hp']) && empty($siswa['ibu_no_hp'])) {
