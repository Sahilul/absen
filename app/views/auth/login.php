...
<head>
  ...
  <style>
    ...
    @media (max-width: 640px) {
      main {
        padding: 1rem 0.75rem; /* Kurangi padding horizontal */
        align-items: flex-start; /* Align ke atas agar bisa scroll */
      }
      
      .glass {
        padding: 1.5rem; /* Kurangi padding card */
        margin-top: 1rem; /* Beri jarak dari atas */
        margin-bottom: 1rem; /* Beri jarak dari bawah */
      }
    ...
    <div class="w-full max-w-md">
      ...
      <div class="glass p-8 space-y-7">
        ...
        <div class="text-center">
          <div class="flex justify-center mb-4">
            ...
            <div class="brand-badge p-2 bg-white rounded-xl shadow-lg">
              <img src="<?= BASEURL; ?>/public/img/app/<?= htmlspecialchars($logoApp); ?>" alt="<?= $namaAplikasi; ?>" class="w-12 h-12 object-contain">
            </div>
            <?php else: ?>
        ...
        <div class="text-center text-xs text-slate-500">
          &copy; <?= date('Y'); ?> <?= $namaAplikasi; ?> • Semua hak dilindungi
        </div>
      </div>
    </div>
  </main>
