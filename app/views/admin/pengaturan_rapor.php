<main class="flex-1 overflow-x-hidden overflow-y-auto bg-secondary-50 p-4 md:p-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                <div>
                    ...
                    <p class="text-slate-500 text-sm">
                        Kelas: <span class="font-semibold text-slate-700"><?= htmlspecialchars($data['wali_kelas_info']['nama_kelas'] ?? '-') ?></span>
                        <span class="mx-2">•</span>
                        Wali Kelas: <span class="font-semibold text-slate-700"><?= htmlspecialchars($data['wali_kelas_info']['nama_guru'] ?? '-') ?></span>
                        <span class="mx-2">•</span>
    ...
    <div class="bg-white shadow-sm rounded-xl p-5 md:p-6">
        <form action="<?= BASEURL ?>/admin/simpanPengaturanRapor" method="POST" enctype="multipart/form-data">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                        <?php if (!empty($data['mapel_list'])): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p class="text-sm text-slate-500 col-span-full">Tidak ada mata pelajaran tersedia untuk kelas ini</p>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="mt-6 flex flex-col sm:flex-row gap-3">
                ...
                <a 
                    href="<?= BASEURL ?>/admin/pengaturanRapor" 
        ...
        <div class="flex gap-3">
            ...
            <div class="flex-1">
                ...
                <ul class="text-xs text-sky-700 space-y-1 list-disc list-inside">
                    ...
                    <li>Anda sedang mengatur pengaturan rapor untuk wali kelas: <strong><?= htmlspecialchars($data['wali_kelas_info']['nama_guru'] ?? '-') ?></strong></li>
