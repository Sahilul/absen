...
<aside id="sidebar" class="sidebar fixed top-0 left-0 z-40 w-64 h-screen flex flex-col border-r border-white/20 shadow-2xl
  ...
  <div
    ...
    <div class="flex items-center">
      ...
      <div class="ml-3 min-w-0">
        ...
        <p class="text-xs text-secondary-500 font-medium mt-0.5">Panel Guru</p>
      </div>
    </div>
  ...
  <nav class="flex-1 sidebar-nav p-4">
    <ul class="space-y-2">
      ...
      <!-- Pesan/Inbox -->
      <li>
        <a href="<?= BASEURL; ?>/guru/pesan"
          class="group flex items-center p-3 text-sm font-semibold rounded-xl transition-all duration-200 <?= (strpos($judul, 'Pesan') !== false) ? 'gradient-success text-white shadow-lg' : 'text-secondary-600 hover:bg-white/60 hover:text-secondary-800'; ?>">
          <div
