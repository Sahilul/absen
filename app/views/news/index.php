...
<head>
    ...
    <title>Berita & Artikel - <?= htmlspecialchars($data['settings']['school_name'] ?? 'Sekolah') ?></title>
...
<body class="bg-slate-50 text-slate-800 antialiased" x-data="{ mobileMenuOpen: false }">
    ...
    <!-- Header -->
    <header class="bg-gradient-to-r from-primary-600 to-primary-700 py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-4">Berita & Artikel</h1>
            <p class="text-primary-100 max-w-2xl mx-auto">Ikuti berita terbaru dan informasi penting dari sekolah kami.
            </p>
        </div>
    </header>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <?php if (empty($data['posts'])): ?>
                <div class="bg-white rounded-2xl p-12 text-center shadow-sm">
                    ...
                    <p class="text-slate-500">Berita dan artikel akan ditampilkan di sini.</p>
                </div>
            <?php else: ?>
                        ...
                        <article class="bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-xl transition-shadow">
                            ...
                            <div class="p-6">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a href="<?= BASEURL ?>/news/detail/<?= $post['slug'] ?>"
                                        class="inline-flex items-center gap-1 text-primary-600 font-semibold text-sm hover:gap-2 transition-all">
                                        Baca
