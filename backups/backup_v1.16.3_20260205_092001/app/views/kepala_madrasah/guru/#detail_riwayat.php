                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 text-right text-sm font-medium">
                                    <div class="flex items-center justify-end space-x-2">
                                        ...
                                        <!-- Tombol Edit Jurnal (Aksi Pertama) -->
                                        ...
                                        <!-- ▼▼▼ PERUBAHAN DI SINI ▼▼▼ -->
                                        <!-- Tombol Edit Absensi (Aksi Tengah) -->
                                        <a href="<?= BASEURL; ?>/guru/absensi/<?= $jurnal['id_jurnal']; ?>" 
                                           class="p-2 rounded-full bg-yellow-100 text-yellow-600 hover:bg-yellow-200 transition" 
                                           title="Edit Absensi">
                                            <i data-lucide="user-check" class="w-5 h-5"></i>
                                        </a>
                                        <!-- ▲▲▲ PERUBAHAN SELESAI ▲▲▲ -->

                                        <!-- Tombol Cetak (Aksi Ketiga) -->
