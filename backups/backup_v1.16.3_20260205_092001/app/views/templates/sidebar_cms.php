    ...
    <div
        ...
        <div class="flex items-center">
            ...
            <div class="ml-3 min-w-0">
                <h1 class="text-lg font-bold text-secondary-800 leading-tight break-words">Website CMS</h1>
                <p class="text-xs text-secondary-500 font-medium mt-0.5">Kelola Konten Publik</p>
            </div>
        </div>
