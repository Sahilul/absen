...
<div class="p-4 sm:p-6">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
    ...
    <div class="flex flex-wrap gap-2">
      ...
      <a href="<?= BASEURL ?>/waliKelas/rekapTagihan"
      ...
      <a href="<?= BASEURL ?>/waliKelas/pembayaranRiwayat"
      ...
      <a href="<?= BASEURL ?>/waliKelas/pembayaranExport"
    ...
    <div class="relative z-10 max-w-2xl w-[92%] sm:w-[560px] mx-auto mt-24">
      <div class="bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        $formAction = isset($data['bendahara_mode']) && $data['bendahara_mode']
          ? BASEURL . '/bendahara/simpanTagihan'
        ...
        <?php foreach ($data['tagihan_list'] as $t): ?>
          <div
            ...
            <div class="grid grid-cols-4 gap-2">
              <a href="<?= BASEURL ?>/waliKelas/pembayaranTagihan/<?= (int) $t['id'] ?>"
