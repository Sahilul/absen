<?php
// File: app/views/psb/register.php
// Form registrasi akun calon siswa PSB
...
<head>
    ...
    <title>Daftar Akun - PSB <?= $namaSekolah; ?></title>
    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-gray-800">Daftar Akun PSB</h1>
                <p class="text-gray-500 mt-1">Buat akun untuk mulai mendaftar</p>
            </div>
            ...
            <!-- Form -->
            <form action="<?= BASEURL; ?>/psb/prosesRegister" method="POST" class="space-y-5">
                <!-- Nama Lengkap -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nama_lengkap" required
                            ...
                            value="<?= $_SESSION['form_data']['nama_lengkap'] ?? ''; ?>">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="nisn" required pattern="[0-9]{10}" maxlength="10"
                            class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all outline-none"
                            placeholder="Masukkan 10 digit NISN" value="<?= $_SESSION['form_data']['nisn'] ?? ''; ?>">
                    </div>
                    <p class="text-xs text-gray-500 mt-1">NISN akan digunakan sebagai username untuk login</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="no_wa" required
                            class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all outline-none"
                            placeholder="Contoh: 08123456789" value="<?= $_SESSION['form_data']['no_wa'] ?? ''; ?>">
                    </div>
                    <p class="text-xs text-gray-500 mt-1">Untuk menerima notifikasi status pendaftaran</p>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <i data-lucide="lock"
                            class="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"></i>
                        <input type="password" name="password_confirm" required minlength="6" id="password_confirm"
                            class="w-full pl-12 pr-12 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all outline-none"
                            placeholder="Ulangi password">
                        <button type="button" onclick="togglePassword('password_confirm')"
                            class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
                            <i data-lucide="eye" class="w-5 h-5" id="password_confirm-icon"></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="text-center space-y-3">
                <p class="text-gray-600">
                    Sudah punya akun?
                    <a href="<?= BASEURL; ?>/psb/login" class="text-green-600 font-semibold hover:underline">Login</a>
                </p>
                <a href="<?= BASEURL; ?>/psb"
