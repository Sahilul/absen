<?php
// File: app/views/guru/jurnal.php
?>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-3xl font-bold text-secondary-800 flex items-center">
                    <i data-lucide="clipboard-pen" class="w-8 h-8 mr-3 text-primary-500"></i>
                    Input Jurnal & Absensi
                </h2>
                <p class="text-secondary-600 mt-2">Pilih kelas untuk memulai jurnal mengajar baru</p>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-secondary-600"><?= $_SESSION['nama_semester_aktif']; ?></p>
                    </div>
                </div>
                <div class="text-right">
                    <p class="text-sm text-secondary-600">Hari ini</p>
                    <p class="font-semibold text-secondary-800"><?= date('d M Y'); ?></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="glass-effect rounded-2xl p-12 border border-white/20 shadow-lg text-center animate-fade-in">
                <div class="max-w-md mx-auto">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="<?= BASEURL; ?>/guru/dashboard" class="btn-primary w-full">
                            <i data-lucide="home" class="w-4 h-4 inline mr-2"></i>Kembali ke Dashboard
                        </a>
                    </div>
                </div>
            </div>
...
// Function untuk cetak (diambil dari riwayat_per_mapel_with_stats.php)
